...
public class CredentialIssuerMetadataRetrieverTest {
    ...
    @DisplayName("That you can set metadata, and retrieve details from the object correctly")
    @Test
    void testIfMetadataIsSavedAndPutIntoCredentialIssuerObjectProperlyAndThatDataFromObjectCanBeRetrieved() throws JsonProcessingException {
